...
### Developer
JellyBolt Games (published by TDSquad AI)
...
### APK Locations
- Debug: `android-app/app/build/outputs/apk/debug/app-debug.apk` (5.2 MB)
- Release: `android-app/app/build/outputs/apk/release/app-release.apk` (1.9 MB)
...
4. Bolt Breaker — Breakout
5. Bounce Blitz — Arcade
...
- [x] Games hosted on GitHub Pages
- [ ] Google Play Console account setup (needs tdsquadai@gmail.com login)
